...
public class SaleEntryController {
    ...
    public GraphResponseDTO getSalesData(@RequestParam String period, @RequestParam(required = true) Long userId,
            @RequestParam(required = false) Long clientId) {
        ...
        List<SaleEntry> entriesNonFiltered;
        ...
        if (clientId == null) {
            ...
            switch (period.toLowerCase()) {
                case "today": {
                    ...
                    entriesNonFiltered = saleEntryRepository
                            .findAllByClient_IdInAndDeleteFlagFalseAndSaleDateTimeBetween(clientIds,
                                    monthStart, monthEnd);

                    List<SaleEntry> daySaleEntries = filterNonDeleted(entriesNonFiltered);
                    // Group entries by day
                    Map<LocalDate, List<SaleEntry>> entriesByDay = daySaleEntries.stream()
                ...
                case "week": {
                    ...
                    List<SaleEntry> weekEntries = filterNonDeleted(entriesNonFiltered);

                    Map<LocalDate, List<SaleEntry>> entriesByDay = weekEntries.stream()
                            .collect(Collectors.groupingBy(e -> e.getSaleDateTime().toLocalDate()));
                ...
                case "month": {
                    ...
                    List<SaleEntry> monthEntries = filterNonDeleted(entriesNonFiltered);
                    // Group entries by month
                    Map<Integer, List<SaleEntry>> entriesByMonth = monthEntries.stream()
            ...
            switch (period.toLowerCase()) {
                case "today": {
                    ...
                    entriesNonFiltered = saleEntryRepository.findByClient_IdAndSaleDateTimeBetween(clientId, monthStart,
                            monthEnd);
                ...
                case "week": {
                    ...
                    entriesNonFiltered = saleEntryRepository.findByClient_IdAndSaleDateTimeBetween(clientId, weekStart,
                            weekEnd);
                ...
                case "month": {
                    ...
                    entriesNonFiltered = saleEntryRepository.findByClient_IdAndSaleDateTimeBetween(clientId, yearStart,
                            yearEnd);
